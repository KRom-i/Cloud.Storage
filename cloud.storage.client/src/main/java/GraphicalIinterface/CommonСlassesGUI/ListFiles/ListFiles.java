...
public class ListFiles extends VBox{
    ...
    public ListFiles (ManagerBox managerBox, MouseManager mouseManager) {
        ...
        ListChangeListener<FileInfo> multiSelection = new ListChangeListener<FileInfo>(){
            ...
            public void onChanged(  Change<? extends FileInfo> changed){
                fileBuffer.buffering(managerBox, changed);
            }
        };
        ...
        setOnMouseEntered((event)-> this.mouseManager.boxMouseEnt(managerBox));
    ...
    public void initInteraction(FileInfo fileInfo){
        ...
        fileInfo.setOnMouseReleased((event -> mouseManager.showMenu(false)));
        fileInfo.setOnMouseDragged((event)-> mouseManager.showMenu(true));
